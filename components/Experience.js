      ...
      <div className="container px-5 py-24 mx-auto">
        ...
        <div className="accordion">
          ...
          <div className="mb-2">
           ...
           {/* SplintX */}
           <div className="mb-2">
            <div className="cursor-pointer bg-gray-800 p-4 flex justify-between items-center shadow-lg" onClick={(e) => toggleExperienceTab(4, e)}>
              <div className="flex items-center">
           ...
           {/* CloutID */}
           <div className="mb-2">
            <div className="cursor-pointer bg-gray-800 p-4 flex justify-between items-center shadow-lg" onClick={(e) => toggleExperienceTab(5, e)}>
              <div className="flex items-center">
          ...
          <div className="mb-2">
            <div className="cursor-pointer bg-gray-800 p-4 flex justify-between items-center shadow-lg" onClick={(e) => toggleExperienceTab(6, e)}>
              <div className="flex items-center">
