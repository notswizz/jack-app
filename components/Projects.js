    ...
    <section id="projects" className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-20">
          ...
          <h1 className="sm:text-3xl text-2xl font-medium title-font text-gray-900">My Portfolio</h1>
        </div>
        <div className="accordion">
          {/* SplintX */}
          <div className="mb-2">
            <div className="cursor-pointer bg-gray-200 p-4 flex justify-between items-center" onClick={(e) => toggleProjectsTab(4, e)}>
              <div className="flex items-center">
                <Image src="/splintx/splintx.png" alt="SplintX Logo" width={100} height={100} />
                <h2 className="ml-4 font-semibold">SplintX</h2>
              </div>
            </div>
            {openProjectsTab === 4 && (
          ...
          {/* CloutID */}
          <div className="mb-2">
            <div className="cursor-pointer bg-gray-200 p-4 flex justify-between items-center" onClick={(e) => toggleProjectsTab(5, e)}>
              <div className="flex items-center">
                <Image src="/cloutid/cloutid.png" alt="CloutID Logo" width={100} height={100} />
                <h2 className="ml-4 font-semibold">cloutIDx</h2>
              </div>
            </div>
            {openProjectsTab === 5 && (
              <div className="bg-white p-4">
